...
<script type="text/javascript">
    sys_info = {"notebook_version": "6.1.4", "notebook_path": "/anaconda/envs/azureml_py36/lib/python3.6/site-packages/notebook", "commit_source": "", "commit_hash": "", "sys_version": "3.6.9 |Anaconda, Inc.| (default, Jul 30 2019, 19:07:31) \n[GCC 7.3.0]", "sys_executable": "/anaconda/envs/azureml_py36/bin/python", "sys_platform": "linux", "platform": "Linux-4.15.0-1098-azure-x86_64-with-debian-stretch-sid", "os_name": "posix", "default_encoding": "UTF-8"};
</script>
